...
const About = () => {
  ...
  return (
    <section className="h-screen bg-gray-100 flex-[1] px-4 pt-6">
      <GoArrowLeft
        onClick={() => router.back()}
        className="absolute top-7 left-3 text-2xl text-gray-400"
      />
      <div className="relative w-[90%] h-9 mb-8 overflow-hidden ml-7">
